...
object OpticDefns {
  ...
  object compose extends Poly2 {
    implicit def default[A, B, C]: shapeless.OpticDefns.compose.Case.Aux[shapeless.Lens[B,C],shapeless.Lens[A,B],shapeless.Lens[A,C]] = at[Lens[B, C], Lens[A, B]](_ compose _)
  }
