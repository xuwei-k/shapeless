...
object zipper {
  implicit def toZipper[L <: HList](l: L): shapeless.syntax.HListZipperOps[L] = new HListZipperOps(l)
  implicit def toZipper[C, CL <: HList](c : C)(implicit gen : Generic.Aux[C, CL]): shapeless.syntax.GenericZipperOps[C,CL] = new GenericZipperOps(c)
}
