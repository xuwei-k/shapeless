...
trait UnwrappedInstances extends LowPriorityUnwrappedInstances {
  ...
  ): shapeless.Unwrapped[W]{type U = UF} = new Unwrapped[W] {
    type U = UF
  ...
  object AnyValHelper {
    ...
    implicit def sizeOneHListHelper[T]: UnwrappedInstances.this.AnyValHelper.Aux[T :: shapeless.HNil,T] =
  ...
  implicit def newtypeUnwrapped[UI, Ops, UF](implicit
    chain: Strict[Unwrapped.Aux[UI, UF]]
  ): shapeless.Unwrapped.Aux[shapeless.newtype.Newtype[UI,Ops],UF] = chain.value.asInstanceOf[Unwrapped.Aux[Newtype[UI, Ops], UF]]

  implicit def tagUnwrapped[T[UI, TT] <: tag.@@[UI, TT], UI, TT, UF](implicit
    chain: Strict[Unwrapped.Aux[UI, UF]]
  ): shapeless.Unwrapped.Aux[T[UI,TT],UF] = chain.value.asInstanceOf[Unwrapped.Aux[T[UI, TT], UF]]
...
trait LowPriorityUnwrappedInstances {
  ...
  implicit def selfUnwrapped[T]: shapeless.Unwrapped.Aux[T,T] =
