...
object hlist {
 ...
 trait Grouper[L <: HList, N <: Nat, Step <: Nat] extends DepFn1[L] with Serializable {
  ...
  object RightScanner {
    ...
    implicit def hlistRightScanner0[H, H0, T <: HList, P <: Poly, C2Result](implicit ev: Case2.Aux[P, H0, H, C2Result]): RightScanner.RightScanner0.Aux[H :: T, H0, P, C2Result :: H :: T] =
